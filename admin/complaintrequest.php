...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  <body>
    ...
    <?php
      ...
      $sql="SELECT * FROM raisecomplaint;";
      ...
      function sorted() 
      {
        ...
        $regno1=$_POST['id'];
        $sql1="UPDATE `raisecomplaint` SET `status`='sorting' where regno='$regno1'";
     ...
     if($query1){
      ...
      function decline() {
        ...
        $regno1=$_POST['id'];
        echo $regno1;
        $sql1="UPDATE `raisecomplaint` SET `status`='declined' where regno='$regno1'";
        $query1=mysqli_query($conn,$sql1);
        if($query1){
          echo "successful";
   ...
   ?>
    <form class="" action="complaintrequest.php" method="post">
