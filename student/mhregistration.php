...
<article class="card card--1">
  ...
  <div class="card__info">
    ...
    <input type="submit" name="fblock" id="fblock" class="card__by" value="select">
...
<article class="card card--2">
  ...
  <div class="card__info">
    ...
    <h3 class="card__title">G block</h3>
        <input type="submit" name="gblock" id="gblock" class="card__by" value="select">
  </div>
</article>
...
<article class="card card--3">
  ...
  <div class="card__info">
    ...
    <h3 class="card__title">H block</h3>
      <input type="submit" name="hblock" id="hblock" class="card__by" value="select">
  </div>
</article>
<!--
