...
<body>
  <div class="container">
    ...
    <div class="content">
      <form action="raisecomplaint.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <textarea name="reason" id="reason" rows="4" cols="30" placeholder="Reason" required></textarea>
          </div>
        </div>
        <div class="button">
...
$reason = $_POST['reason'];
$sql = "SELECT * FROM raisecomplaint WHERE regno='$regno' AND status='Pending'";
if ($result=mysqli_query($conn,$sql)) {
  ...
  $errmsg="*You already had a one complain";
   ...
   require_once('../dbConnect.php');
 $sql="INSERT INTO `raisecomplaint` (`name`,`regno`,`block`,`roomno`,`reason`,`status`)VALUES ('$name','$regno','$block','$roomno','$reason','Pending')";
